...
// Filename: vesreb.ggsk
// Generated 2026-04-18T17:02:25
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs+='bottom : -2px;';
		hs+='height : 58px;';
		hs+='left : calc(50% - ((379px + 0px) / 2) - 2.5px);';
		hs+='opacity : 0.5;';
		...
		me._container_main_control.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._container_main_control.style.transition='none';
			} else {
				me._container_main_control.style.transition='all 500ms ease-out 0ms';
			}
			...
			if (player.transitionsDisabled) {
				me._glow.style.transition='none';
			} else {
				me._glow.style.transition='all 500ms ease-out 0ms';
			}
			me._glow.style.opacity='1';
			me._glow.style.visibility=me._glow.ggVisible?'inherit':'hidden';
			me.elementMouseOver['container_main_control']=true;
		}
		me._container_main_control.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me._container_main_control.style.transition='none';
			} else {
				me._container_main_control.style.transition='all 500ms ease-out 0ms';
			...
			me.elementMouseOver['container_main_control']=false;
		}
		...
		el.ggSubElement = els;
		el.ggId="glow";
		el.ggParameter={ rx:0,ry:0,a:0,sx:0.9,sy:1,def:'' };
		el.ggVisible=true;
		...
		me._info.onclick=function (e) {
			...
			me._screen.style.transition='none';
			...
			me._screen.style.transform=parameterToTransform(me._screen.ggParameter);
			skin.updateSize(me._screen);
			me._screen.style.transition='none';
		...
		me._info.onmouseenter=function (e) {
			...
			me._txt_info.style.transition='none';
		...
		me._info.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_info.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._zoom_in.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._zoom_in.style.transition='none';
			} else {
				me._zoom_in.style.transition='all 1000ms ease-out 0ms';
			}
			me._zoom_in.ggParameter.rx=0;me._zoom_in.ggParameter.ry=-4;
			me._zoom_in.style.transform=parameterToTransform(me._zoom_in.ggParameter);
			me._txt_zoom_in.style.transition='none';
		...
		me._zoom_in.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_zoom_in.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._zoom_out.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._zoom_out.style.transition='none';
			} else {
				me._zoom_out.style.transition='all 1000ms ease-out 0ms';
			}
			me._zoom_out.ggParameter.rx=0;me._zoom_out.ggParameter.ry=-4;
			me._zoom_out.style.transform=parameterToTransform(me._zoom_out.ggParameter);
			me._txt_zoom_out.style.transition='none';
		...
		me._zoom_out.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_zoom_out.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._left.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_left.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._right.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._right.style.transition='none';
			} else {
				me._right.style.transition='all 1000ms ease-out 0ms';
			}
			...
			me._txt_right.style.transition='none';
		...
		me._right.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_right.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._up.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_up.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._down.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_down.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._autorotate.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._autorotate.style.transition='none';
			} else {
				me._autorotate.style.transition='all 1000ms ease-out 0ms';
			}
			me._autorotate.ggParameter.rx=0;me._autorotate.ggParameter.ry=-4;
			me._autorotate.style.transform=parameterToTransform(me._autorotate.ggParameter);
			me._txt_autorotate.style.transition='none';
		...
		me._autorotate.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_autorotate.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._reset_view.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._reset_view.style.transition='none';
			} else {
				me._reset_view.style.transition='all 1000ms ease-out 0ms';
			}
			me._reset_view.ggParameter.rx=0;me._reset_view.ggParameter.ry=-4;
			me._reset_view.style.transform=parameterToTransform(me._reset_view.ggParameter);
			me._txt_reset_view.style.transition='none';
			me._txt_reset_view.style.opacity='1';
			me._txt_reset_view.style.visibility=me._txt_reset_view.ggVisible?'inherit':'hidden';
			me.elementMouseOver['reset_view']=true;
		}
		...
		me._reset_view.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me._reset_view.style.transition='none';
			} else {
				me._reset_view.style.transition='all 1000ms ease-out 0ms';
			...
			if (player.transitionsDisabled) {
				...
				me._txt_reset_view.style.transition='all 500ms ease-out 0ms';
			}
			me._txt_reset_view.style.opacity='0';
			me._txt_reset_view.style.visibility='hidden';
			me.elementMouseOver['reset_view']=false;
		}
		...
		me._fullscreen.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				...
				me._fullscreen.style.transition='all 1000ms ease-out 0ms';
			}
			...
			me._txt_fullscreen.style.transition='none';
		...
		me._fullscreen.onmouseleave=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._txt_fullscreen.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._hide.onclick=function (e) {
			...
			me._container_main_control.style.transform=parameterToTransform(me._container_main_control.ggParameter);
			setTimeout(function() {skin.updateSize(me._container_main_control);}, 49);
			if (player.transitionsDisabled) {
				me._container_main_control.style.transition='none';
			} else {
				me._container_main_control.style.transition='all 1000ms ease-out 0ms';
			}
			me._container_main_control.ggParameter.rx=0;me._container_main_control.ggParameter.ry=80;
			me._container_main_control.style.transform=parameterToTransform(me._container_main_control.ggParameter);
			me._hide.style.transition='none';
			me._hide.style.opacity='0';
			me._hide.style.visibility='hidden';
			if (player.transitionsDisabled) {
				me._show.style.transition='none';
			} else {
				me._show.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._hide.onmouseenter=function (e) {
			me._hide__img.src=me._hide__img.ggOverSrc;
			me.elementMouseOver['hide']=true;
		}
		...
		me._hide.onmouseleave=function (e) {
			me._hide__img.src=me._hide__img.ggNormalSrc;
			me.elementMouseOver['hide']=false;
		}
		...
		me._show.onclick=function (e) {
			...
			if (player.transitionsDisabled) {
				...
				me._hide.style.transition='all 500ms ease-out 0ms';
			}
		...
		me._show.onmouseenter=function (e) {
			me._show__img.src=me._show__img.ggOverSrc;
			me.elementMouseOver['show']=true;
		}
		...
		me._show.onmouseleave=function (e) {
			me._show__img.src=me._show__img.ggNormalSrc;
			me.elementMouseOver['show']=false;
		}
		...
		hs ='';
		hs+='height : 74px;';
		hs+='left : calc(50% - ((224px + 0px) / 2) - 8px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((74px + 0px) / 2) - 83px);';
		hs+='visibility : inherit;';
		hs+='width : 224px;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
		...
		me._text_3.ggUpdateText=function() {
			...
			var hs = player._("<font face=\"Tahoma\"><b>Loading  %1 % \/ %2 kB<\/b><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		hs+='cursor : pointer;';
		hs+='height : auto;';
		hs+='left : calc(50% - ((calc(740px + 6px) + 6px) / 2) + 5px);';
		hs+='position : absolute;';
		hs+='top : 6px;';
		hs+='visibility : hidden;';
		hs+='width : calc(740px + 6px);';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		hs ='';
		...
		hs+='overflow-y: auto;';
		els.setAttribute('style',hs);
		me._html_box.ggUpdateText=function() {
			var params = [];
		...
		me._html_box.ondblclick=function (e) {
			me._html_box.style.transition='none';
		...
		me._text_2.ggUpdateText=function() {
			var params = [];
			var hs = player._("\u0417\u0430\u043a\u0440\u044b\u0442\u044c \u0425", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		hs ='';
		hs+='height : 238px;';
		hs+='left : calc(50% - ((403px + 0px) / 2) + 0px);';
		hs+='opacity : 0.69999;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((238px + 0px) / 2) + 36px);';
		hs+='visibility : inherit;';
		hs+='width : 403px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._screen.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me._screen.style.transition='none';
			} else {
				me._screen.style.transition='all 500ms ease-out 0ms';
			}
			me._screen.style.opacity='1';
			me._screen.style.visibility=me._screen.ggVisible?'inherit':'hidden';
			me.elementMouseOver['screen']=true;
		}
		me._screen.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me._screen.style.transition='none';
			} else {
				me._screen.style.transition='all 500ms ease-out 0ms';
			...
			me._screen.style.visibility=me._screen.ggVisible?'inherit':'hidden';
			me.elementMouseOver['screen']=false;
		}
		...
		me._close.onclick=function (e) {
			...
			me._screen.style.transform=parameterToTransform(me._screen.ggParameter);
			setTimeout(function() {skin.updateSize(me._screen);}, 49);
			if (player.transitionsDisabled) {
				me._screen.style.transition='none';
			} else {
				me._screen.style.transition='all 1000ms ease-out 0ms';
			}
		...
		me._title.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"2\"  ><b><i>\u0421\u0444\u0435\u0440\u0438\u0447\u0435\u0441\u043a\u0438\u0435, \u0446\u0438\u043b\u0438\u043d\u0434\u0440\u0438\u0447\u0435\u0441\u043a\u0438\u0435 \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u044b, \u0421\u0430\u0439\u0442\u044b, \u0412\u0438\u0440\u0442\u0443\u0430\u043b\u044c\u043d\u044b\u0435 \u0442\u0443\u0440\u044b,360\xb0 \u0432\u0438\u0434\u0435\u043e, \u0442\u0440\u0430\u0434\u0438\u0446\u0438\u043e\u043d\u043d\u0430\u044f \u0424\u043e\u0442\u043e\u0433\u0440\u0430\u0444\u0438\u044f.<br\/><\/b><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._description.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"2\"  ><b>\xab\u0412 \u0410\u0440\u0445\u0430\u043d\u0433\u0435\u043b\u044c\u0441\u043a(\u0443\u042e) \u0432\u043e\u043a\u0440\u0443\u0433 \u043c\u0430\u0440\u0448!\xbb  \u0421\u0444\u0435\u0440\u0438\u0447\u0435\u0441\u043a\u0438\u0435 \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u044b\u0432 \u0410\u0440\u0445\u0430\u043d\u0433\u0435\u043b\u044c\u0441\u043a\u0430 \u0438 \u043e\u0431\u043b\u0430\u0441\u0442\u0438 2010-2026 \u043d\u0430 \u043a\u0430\u0440\u0442\u0435.<\/font >", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._copyright.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"4\" ><a href=\"https:\/\/yakov72.github.io\/pano\/\" target=\"_blank\"><u><b>https:\/\/yakov72.github.io\/pano\/<\/a><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._copyright1.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"2\" ><\/u>\u0424\u043e\u0442\u043e\u0441\u044a\u0435\u043c\u043a\u0430 \u0438 \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u0441\u0444\u0435\u0440\u0438\u0447\u0435\u0441\u043a\u0438\u0445 \u043f\u0430\u043d\u043e\u0440\u0430\u043c\n\u0427\u0443\u0440\u0431\u0430\u043d\u043e\u0432 \u042f\u043a\u043e\u0432,<a href=\"mailto:CHYL@MAIL.RU?subject=\u0412\u043e\u043f\u0440\u043e\u0441 \u043f\u043e 3D \u043f\u0430\u043d\u043e\u0440\u0430\u043c\u0430\u043c\"> <ins>CHYL@MAIL.RU<\/ins>, <\/a>+7-963-2009759\n<\/font>\n", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._copyright2.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"2\" ><a href=\"https:\/\/vk.com\/yakov.churbanov\" target=\"_blank\"><u><b>https:\/\/vk.com\/yakov.churbanov<\/a><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._image_1mag.onmouseenter=function (e) {
			me.elementMouseOver['image_1mag']=true;
		}
		me._image_1mag.onmouseleave=function (e) {
			me.elementMouseOver['image_1mag']=false;
		}
		me._image_1mag.ggUpdateConditionTimer=function () {
			if (me.elementMouseOver['image_1mag']) {
				me._text_.style.transition='none';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_6helptext0.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"1.8\"><b><i>\u041a\u0430\u043a \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u044c\u0441\u044f \u043d\u0430\u0448\u0438\u043c \u0432\u0438\u0440\u0442\u0443\u0430\u043b\u044c\u043d\u044b\u043c \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u043e\u043c ? &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n\u041f\u043e\u0433\u0443\u043b\u044f\u0439\u0442\u0435 \u0432\u0438\u0440\u0442\u0443\u0430\u043b\u044c\u043d\u043e, \u043e\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435\u0441\u044c. \u0420\u0430\u0441\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435 \u0434\u0435\u0442\u0430\u043b\u044c\u043d\u043e \u043d\u0430\u0448\u0438 \u0442\u043e\u0432\u0430\u0440\u044b, \u043f\u0440\u0438\u0431\u043b\u0438\u0436\u0430\u044f \u0438\u0445 \u043a\u043e\u043b\u0435\u0441\u0438\u043a\u043e\u043c \u043c\u044b\u0448\u043a\u0438.  \u041d\u0430\u0432\u0435\u0434\u0438\u0442\u0435 \u043a\u0440\u0430\u0441\u043d\u044b\u0439 \u043a\u0432\u0430\u0434\u0440\u0430\u0442\u0438\u043a  (\u043a\u043e\u0442\u043e\u0440\u044b\u0439 \u0432\u043d\u0443\u0442\u0440\u0438 \u0440\u043e\u0437\u043e\u0432\u043e\u0433\u043e \u0446\u0432\u0435\u0442\u0430 \u0432 \u043a\u0440\u0430\u0441\u043d\u043e\u0439 \u0440\u0430\u043c\u043a\u0435) \u043d\u0430 \u0442\u043e , \u0447\u0442\u043e \u0432\u0430\u0441 \u0437\u0430\u0438\u043d\u0442\u0435\u0440\u0435\u0441\u043e\u0432\u0430\u043b\u043e. \u041f\u043e\u0441\u043b\u0435 \u0447\u0435\u0433\u043e \u0432\u044b \u043c\u043e\u0436\u0435\u0442\u0435 : \n<img src=\"images\/clip.png\"  width=\"18\" height=\"18\" alt=\"clip111.png\"> \u0421\u043a\u043e\u043f\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u0441\u0441\u044b\u043b\u043a\u0443 \u043d\u0430 \u043a\u043e\u043d\u043a\u0440\u0435\u0442\u043d\u044b\u0439 \u0442\u043e\u0432\u0430\u0440 \u0432 \u0431\u0443\u0444\u0435\u0440 \u043e\u0431\u043c\u0435\u043d\u0430 (\u043d\u0430\u043f\u0440\u0438\u043c\u0435\u0440 \u0447\u0442\u043e \u0431\u044b \u043f\u043e\u0441\u043b\u0430\u0442\u044c \u0435\u0435 \u0434\u0440\u0443\u0437\u044c\u044f\u043c, \u0438\u043b\u0438 \u0441\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0435\u0435 \u0443 \u0441\u0435\u0431\u044f, \u0447\u0442\u043e \u0431\u044b \u0441\u0434\u0435\u043b\u0430\u0442\u044c \u043d\u0430\u043f\u0440\u0438\u043c\u0435\u0440 \u0437\u0430\u043a\u0430\u0437 \u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u0438\u0445 \u0442\u043e\u0432\u0430\u0440\u043e\u0432)  \u043a\u043b\u0438\u043a\u043d\u0438\u0442\u0435 \u043d\u0430 \u0438\u043a\u043e\u043d\u043a\u0443 \u0431\u043b\u043e\u043a\u043d\u043e\u0442\u0430 \u0432 \u043b\u0435\u0432\u043e\u043c \u043d\u0438\u0436\u043d\u0435\u043c \u0443\u0433\u043b\u0443. \n<img src=\"images\/mail.png\"  width=\"18\" height=\"18\" alt=\"clip111.png\"> \u041d\u0430\u043f\u0438\u0441\u0430\u0442\u044c \u043d\u0430\u043c \u043f\u0438\u0441\u044c\u043c\u043e, \u0441 \u0443\u043a\u0430\u0437\u0430\u043d\u0438\u0435\u043c \u0441\u0441\u044b\u043b\u043a\u0438 \u043d\u0430 \u043a\u043e\u043d\u043a\u0440\u0435\u0442\u043d\u044b\u0439 \u0442\u043e\u0432\u0430\u0440 \u0438 \u0437\u0430\u0434\u0430\u0442\u044c \u0432\u043e\u043f\u0440\u043e\u0441\u044b \u043e \u0442\u043e\u0447\u043d\u043e\u0439 \u0446\u0435\u043d\u0435, \u0434\u043e\u0441\u0442\u0430\u0432\u043a\u0435 \u0438 \u043f\u0440\u043e\u0447\u0435\u043c, \u043a\u043b\u0438\u043a\u043d\u0438\u0442\u0435 \u043d\u0430 \u0438\u043a\u043e\u043d\u043a\u0443 \u043f\u0438\u0441\u044c\u043c\u0430 \u0432 \u043f\u0440\u0430\u0432\u043e\u043c \u043d\u0438\u0436\u043d\u0435\u043c \u0443\u0433\u043b\u0443. <br\/>\u041c\u044b \u0441 \u0440\u0430\u0434\u043e\u0441\u0442\u044c\u044e \u043e\u0442\u0432\u0435\u0442\u0438\u043c \u043d\u0430 \u0432\u0430\u0448\u0438 \u0432\u043e\u043f\u0440\u043e\u0441\u044b.<\/font>\n<font size=\"1.7\">\xab\u041f\u0442\u0438\u0446\u0430 \u0441\u0447\u0430\u0441\u0442\u044c\u044f\xbb \u0410\u0440\u0445\u0430\u043d\u0433\u0435\u043b\u044c\u0441\u043a, \u043f\u0440. \u0427\u0443\u043c\u0431\u0430\u0440\u043e\u0432\u0430-\u041b\u0443\u0447\u0438\u043d\u0441\u043a\u043e\u0433\u043e 29<u><b><br\/><a href=\"https:\/\/vk.link\/arhpticas\" target=\"_blank\"> https:\/\/vk.link\/arhpticas  <\/a><\/u><\/b> <a href=\"mailto:arhpticas@yandex.ru?subject=\u0412\u043e\u043f\u0440\u043e\u0441 \u043f\u043e ..............\"><u>arhpticas@yandex.ru<\/u><\/a><\/font>\n<font size=\"1.7\"><b><i><\/u> \u0424\u043e\u0442\u043e \u0438 \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u0442\u0443\u0440\u0430 - \u042f\u043a\u043e\u0432 \u0427\u0443\u0440\u0431\u0430\u043d\u043e\u0432 <a href=\"https:\/\/www.churbanov.net\" target=\"_blank\">www.churbanov.net<\/a> <a href=\"mailto:chyl@mail.ru?subject=\u0412\u043e\u043f\u0440\u043e\u0441 \u043a \u0440\u0430\u0437\u0440\u0430\u0431\u043e\u0442\u0447\u0438\u043a\u0443\">chyl@mail.ru<\/a><\/u><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_6helptext0.ggUpdateText();
		el.appendChild(els);
		...
		me._text_6helptext0.onclick=function (e) {
			me._text_6helptext0.style.transition='none';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_6helptext.ggUpdateText=function() {
			var params = [];
			var hs = player._("<font size=\"1.8\"><b><i>\u0414\u0435\u0442\u0441\u043a\u0438\u0439 \u0441\u0430\u0434 \u211633 \u0433. \u0410\u0440\u0445\u0430\u043d\u0433\u0435\u043b\u044c\u0441\u043a\u0430\u044f  \u0410\u0424\u0428.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\n\u041f\u043e\u0434\u0433\u043e\u0442\u043e\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u0430\u044f \u0433\u0440\u0443\u043f\u043f\u0430 1979 \u0433\u043e\u0434.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> \u0420\u0430\u0441\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435 \u0432\u0441\u0435\u0445 \u0434\u0435\u0442\u0430\u043b\u044c\u043d\u043e \u043c\u043e\u0436\u043d\u043e \u0434\u0432\u0438\u0433\u0430\u044f \u0438 \u043f\u0440\u0438\u0431\u043b\u0438\u0436\u0430\u044f \u0435\u0435 \u043a\u043e\u043b\u0435\u0441\u0438\u043a\u043e\u043c \u043c\u044b\u0448\u043a\u0438. <\/font>\n<font size=\"1.7\"><b><i><\/u> \u0424\u043e\u0442\u043e \u0438 \u0430\u043d\u0438\u043c\u0430\u0446\u0438\u044f \u0434\u043b\u044f \u0432\u0435\u0431 - \u042f\u043a\u043e\u0432 \u0427\u0443\u0440\u0431\u0430\u043d\u043e\u0432 <a href=\"https:\/\/vk.com\/yakov.churbanov\" target=\"_blank\">https:\/\/vk.com\/yakov.churbanov<\/a> <a href=\"mailto:chyl@mail.ru?subject=\u0412\u043e\u043f\u0440\u043e\u0441 \u043a \u0444\u043e\u0442\u043e\u0433\u0440\u0430\u0444\u0443\">chyl@mail.ru<\/a><\/u><\/font><font size=\"1.7\">.<u><b><\/font>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_6helptext.ggUpdateText();
		el.appendChild(els);
		...
		me._text_6helptext.onclick=function (e) {
			me._text_6helptext.style.transition='none';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_4help.ggUpdateText=function() {
			var params = [];
			var hs = player._("\u041f\u043e\u043c\u043e\u0449\u044c", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_.ggUpdateText=function() {
			var params = [];
			var hs = player._("\u041c\u043e\u044f \u0433\u0440\u0443\u043f\u043f\u0430 \u0432 \u0412\u041a <a href=\"https:\/\/vk.com\/yandexmappanorama\" target=\"_blank\"><u><b>\nvk.com\/yandexmappanorama<\/a>\n360\xb0 \u041f\u0410\u041d\u041e\u0420\u0410\u041c\u042b. \u042f\u041d\u0414\u0415\u041a\u0421-\u041a\u0410\u0420\u0422\u042b. \u0414\u043b\u044f \u0432\u0430\u0448\u0435\u0433\u043e \u0441\u0430\u0439\u0442\u0430. \u0421\u044a\u0435\u043c\u043a\u0430. \u0410\u0440\u0445\u0430\u043d\u0433\u0435\u043b\u044c\u0441\u043a", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_.onclick=function (e) {
			me._text_6helptext.ggVisible = !me._text_6helptext.ggVisible;
			var flag=me._text_6helptext.ggVisible;
			me._text_6helptext.style.transition='none';
			me._text_6helptext.style.visibility=((flag)&&(Number(me._text_6helptext.style.opacity)>0||!me._text_6helptext.style.opacity))?'inherit':'hidden';
		}
		me._text_.onmouseleave=function (e) {
			me._text_.style.transition='none';
		...
		el=me._text_4help1=document.createElement('div');
		els=me._text_4help1__text=document.createElement('div');
		el.className='ggskin ggskin_textdiv';
		el.ggTextDiv=els;
		el.ggId="=Text 4-help1";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_4help1.ggUpdateText=function() {
			var params = [];
			var hs = player._("\u041a\u0442\u043e \u043d\u0430\n \u0444\u043e\u0442\u043e", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me._text_4help1.ggUpdateText();
		el.appendChild(els);
		me._text_4help1.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._text_4help1.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._text_4help1);
		me.elementMouseOver['container_main_control']=false;
		me.elementMouseOver['info']=false;
		me.elementMouseOver['zoom_in']=false;
		me.elementMouseOver['zoom_out']=false;
		...
		player.addListener('imagesready', function(event) {
			if (player.transitionsDisabled) {
				me._loader.style.transition='none';
			} else {
				me._loader.style.transition='all 500ms ease-out 0ms';
			}
	...
	function SkinHotspotClass_sl(parentScope,hotspot) {
		...
		hs+='cursor : pointer;';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) + 36px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((0px + 0px) / 2) + 107px);';
		hs+='visibility : inherit;';
		hs+='width : 0px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._sl.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['sl']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._sl.onmouseleave=function (e) {
			me.elementMouseOver['sl']=false;
		...
		el.ggDx=3;
		el.ggDy=4;
		el.ggParameter={ rx:0,ry:0,a:-90,sx:0.55,sy:0.55,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_button ";
		el.ggType='button';
		hs ='';
		hs+='cursor : pointer;';
		hs+='height : 70px;';
		hs+='left : calc(50% - ((70px + 0px) / 2) + 3px);';
		hs+='opacity : 0.60001;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((70px + 0px) / 2) + 4px);';
		hs+='visibility : inherit;';
		hs+='width : 70px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me.__45.onclick=function (e) {
				skin._html_box.ggUpdateText=function() {
					...
					var hs = player._("<br><iframe width=\"735\" height=\"700\" src=\"%1\" frameborder=\"0\"><\/iframe>", params);
					if (hs!=this.ggText) {
						this.ggText=hs;
						this.ggTextDiv.innerHTML=hs;
						if (this.ggUpdatePosition) this.ggUpdatePosition();
			...
			skin._html_box.ggUpdateText();
			skin._html_box.ggTextDiv.scrollTop = 0;
			skin._html_box.style.transition='none';
		...
		hs+='cursor : pointer;';
		hs+='height : auto;';
		hs+='left : calc(50% - ((200px + 0px) / 2) + 2px);';
		hs+='position : absolute;';
		hs+='top : 23px;';
		hs+='visibility : inherit;';
		hs+='width : 200px;';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_su.ggUpdateText=function() {
			var params = [];
	...
	function SkinHotspotClass_sr(parentScope,hotspot) {
		...
		hs+='cursor : pointer;';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) - 91px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((0px + 0px) / 2) + 138px);';
		hs+='visibility : inherit;';
		hs+='width : 0px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._sr.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['sr']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._sr.onmouseleave=function (e) {
			me.elementMouseOver['sr']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_su0.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.description)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
	...
	function SkinHotspotClass_su(parentScope,hotspot) {
		...
		hs+='cursor : pointer;';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) - 342px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((0px + 0px) / 2) + 201px);';
		hs+='visibility : inherit;';
		hs+='width : 0px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._su.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['su']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._su.onmouseleave=function (e) {
			me.elementMouseOver['su']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_su1.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.description)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
	...
	function SkinHotspotClass_sd(parentScope,hotspot) {
		...
		el.ggDx=-295;
		el.ggDy=51;
		el.ggParameter={ rx:0,ry:0,a:180,sx:0.55,sy:0.55,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_hotspot ";
		el.ggType='hotspot';
		hs ='';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) - 295px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((0px + 0px) / 2) + 51px);';
		hs+='visibility : inherit;';
		hs+='width : 0px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		me._sd.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['sd']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._sd.onmouseleave=function (e) {
			me.elementMouseOver['sd']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='cursor : pointer;';
		hs+='height : 70px;';
		hs+='left : calc(50% - ((70px + 0px) / 2) + 1px);';
		hs+='opacity : 0.60001;';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((70px + 0px) / 2) + 4px);';
		hs+='visibility : inherit;';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._text_sd.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.description)));
			var hs = player._("%1", params);
			if (hs!=this.ggText) {
	...
	function SkinHotspotClass__1(parentScope,hotspot) {
		...
		hs ='';
		hs+='height : 0px;';
		hs+='left : calc(50% - ((0px + 0px) / 2) + 318px);';
		hs+='position : absolute;';
		hs+='top : calc(50% - ((0px + 0px) / 2) - 72px);';
		hs+='visibility : inherit;';
		hs+='width : 0px;';
		hs+='pointer-events:auto;';
		el.setAttribute('style',hs);
		...
		el.ggTextDiv=els;
		el.ggId="txt45";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1.3,sy:1.3,def:'' };
		el.ggVisible=false;
		el.className="ggskin ggskin_text ";
		el.ggType='text';
		hs ='';
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me._txt45.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
		...
		me.__453.onmouseenter=function (e) {
			me.__453.style.transition='none';
			me.__453.ggParameter.sx=0.4;me.__453.ggParameter.sy=0.4;
			me.__453.style.transform=parameterToTransform(me.__453.ggParameter);
			skin.updateSize(me.__453);
			me.__453.style.transition='none';
			me.__453.style.opacity='1';
			me.__453.style.visibility=me.__453.ggVisible?'inherit':'hidden';
			me._txt45.style.transition='none';
			me._txt45.style.visibility='hidden';
			me._txt45.ggVisible=false;
			me.elementMouseOver['_453']=true;
		}
		me.__453.onmouseleave=function (e) {
			me.__453.style.transition='none';
			...
			me._txt45.style.visibility='hidden';
			me._txt45.ggVisible=false;
			me.elementMouseOver['_453']=false;
		}
	...
	function SkinHotspotClass_m41(parentScope,hotspot) {
		...
		me._m41.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['m41']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._m41.onmouseleave=function (e) {
			me.elementMouseOver['m41']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		me._hsimage_q.onmouseenter=function (e) {
			me.elementMouseOver['hsimage_q']=true;
		}
		me._hsimage_q.onmouseleave=function (e) {
			me._hsimage_q.style.transition='none';
			me._hsimage_q.ggParameter.sx=1;me._hsimage_q.ggParameter.sy=1;
			me._hsimage_q.style.transform=parameterToTransform(me._hsimage_q.ggParameter);
			skin.updateSize(me._hsimage_q);
			me.elementMouseOver['hsimage_q']=false;
		}
		me._hsimage_q.ggUpdateConditionTimer=function () {
		...
		me.elementMouseOver['hsimage_q']=false;
			me.hotspotTimerEvent=function() {
				me._hsimage_q.ggUpdateConditionTimer();
			}
	...
	function SkinHotspotClass_hsn(parentScope,hotspot) {
		...
		me._hsn.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['hsn']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsn.onmouseleave=function (e) {
			me.elementMouseOver['hsn']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
	...
	function SkinHotspotClass_hsp(parentScope,hotspot) {
		...
		me._hsp.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['hsp']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsp.onmouseleave=function (e) {
			me.elementMouseOver['hsp']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
	...
	function SkinHotspotClass_hsd(parentScope,hotspot) {
		...
		me._hsd.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['hsd']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsd.onmouseleave=function (e) {
			me.elementMouseOver['hsd']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__23w.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
			var hs = player._("<b><i>%1<\/i><\/b>", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
				this.ggTextDiv.innerHTML=hs;
				if (this.ggUpdatePosition) this.ggUpdatePosition();
		...
		me.__454.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me.__454.style.transition='none';
			} else {
				me.__454.style.transition='all 500ms ease-out 0ms';
			}
			me.__454.ggParameter.sx=1.5;me.__454.ggParameter.sy=1.5;
			me.__454.style.transform=parameterToTransform(me.__454.ggParameter);
			setTimeout(function() {skin.updateSize(me.__454);}, 49);
			me.elementMouseOver['_454']=true;
		}
		me.__454.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me.__454.style.transition='none';
			} else {
				me.__454.style.transition='all 500ms ease-out 0ms';
			...
			me.__454.style.transform=parameterToTransform(me.__454.ggParameter);
			setTimeout(function() {skin.updateSize(me.__454);}, 49);
			me.elementMouseOver['_454']=false;
		}
	...
	function SkinHotspotClass_hsr(parentScope,hotspot) {
		...
		me._hsr.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['hsr']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsr.onmouseleave=function (e) {
			me.elementMouseOver['hsr']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__23w0.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
			var hs = player._("<b><i>%1<\/i><\/b>", params);
			if (hs!=this.ggText) {
		...
		me.__455.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me.__455.style.transition='none';
			} else {
				me.__455.style.transition='all 500ms ease-out 0ms';
			}
			me.__455.ggParameter.sx=1.5;me.__455.ggParameter.sy=1.5;
			me.__455.style.transform=parameterToTransform(me.__455.ggParameter);
			setTimeout(function() {skin.updateSize(me.__455);}, 49);
			me.elementMouseOver['_455']=true;
		}
		me.__455.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me.__455.style.transition='none';
			} else {
				me.__455.style.transition='all 500ms ease-out 0ms';
			...
			me.__455.style.transform=parameterToTransform(me.__455.ggParameter);
			setTimeout(function() {skin.updateSize(me.__455);}, 49);
			me.elementMouseOver['_455']=false;
		}
	...
	function SkinHotspotClass_hsl(parentScope,hotspot) {
		...
		me._hsl.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.__456.style.transition='none';
			me.__456.ggParameter.sx=1.35;me.__456.ggParameter.sy=1.35;
			me.__456.style.transform=parameterToTransform(me.__456.ggParameter);
			skin.updateSize(me.__456);
			me.elementMouseOver['hsl']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsl.onmouseleave=function (e) {
			me.__456.style.transition='none';
			me.__456.ggParameter.sx=1;me.__456.ggParameter.sy=1;
			me.__456.style.transform=parameterToTransform(me.__456.ggParameter);
			skin.updateSize(me.__456);
			me.elementMouseOver['hsl']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__23w1.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
			var hs = player._("<b><i>%1<\/i><\/b>", params);
			if (hs!=this.ggText) {
		...
		me.__456.onmouseenter=function (e) {
			if (player.transitionsDisabled) {
				me.__456.style.transition='none';
			} else {
				me.__456.style.transition='all 500ms ease-out 0ms';
			}
			me.__456.ggParameter.sx=1.5;me.__456.ggParameter.sy=1.5;
			me.__456.style.transform=parameterToTransform(me.__456.ggParameter);
			setTimeout(function() {skin.updateSize(me.__456);}, 49);
			me.elementMouseOver['_456']=true;
		}
		me.__456.onmouseleave=function (e) {
			if (player.transitionsDisabled) {
				me.__456.style.transition='none';
			} else {
				me.__456.style.transition='all 500ms ease-out 0ms';
			...
			me.__456.style.transform=parameterToTransform(me.__456.ggParameter);
			setTimeout(function() {skin.updateSize(me.__456);}, 49);
			me.elementMouseOver['_456']=false;
		}
	...
	function SkinHotspotClass_hsu(parentScope,hotspot) {
		...
		me._hsu.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['hsu']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me._hsu.onmouseleave=function (e) {
			me.elementMouseOver['hsu']=false;
			player.triggerEvent('hsproxyout', {'id': me.hotspot.id, 'url': me.hotspot.url});
			player.setActiveHotspot(null);
		}
		...
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		me._svg_56.onmouseenter=function (e) {
			me._svg_56.style.transition='none';
			...
			me._svg_56.style.transform=parameterToTransform(me._svg_56.ggParameter);
			skin.updateSize(me._svg_56);
			me.elementMouseOver['svg_56']=true;
		}
		me._svg_56.onmouseleave=function (e) {
			me._svg_56.style.transition='none';
			...
			me._svg_56.style.transform=parameterToTransform(me._svg_56.ggParameter);
			skin.updateSize(me._svg_56);
			me.elementMouseOver['svg_56']=false;
		}
		...
		hs+='overflow: hidden;';
		els.setAttribute('style',hs);
		me.__23w2.ggUpdateText=function() {
			var params = [];
			params.push(String(player._(me.hotspot.title)));
			var hs = player._("<b><i>%1<\/i><\/b>", params);
			if (hs!=this.ggText) {
